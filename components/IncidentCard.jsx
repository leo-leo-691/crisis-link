  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-3">
        <TypeIcon type={incident.type} size={36} />
          ...
          <div className="flex items-center flex-wrap gap-1.5">
            ...
            {incident.is_drill && (
              <span className="mono font-bold" style={{
                padding: '3px 8px', borderRadius: 100, fontSize: 9, letterSpacing: '0.08em',
        ...
        <div className="text-right flex-shrink-0 space-y-1">
          ...
          <p className="mono" style={{ fontSize: 10, color: 'rgba(232,234,240,0.25)' }}>
            #{incident.id?.slice(-6)}
          </p>
        </div>
      </div>
